...
var _jsxFileName = "C:\\Users\\pkellner\\Documents\\pluralsight-course-using-react-hooks\\04-Built-In-Hooks\\_experimental\\pages\\speaker.js";
...
function (_Component) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = _ref.query;
                promise = axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("".concat(Speaker.GetSpeakerUrl(), "/").concat(query.speakerId)).then(function (response) {
                  return {
                    hasErrored: false,
  ...
  function Speaker(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Speaker).call(this, props));
    _this.state = {
  ...
  _createClass(Speaker, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        __self: this
      }, this.state.speakerDataOne.firstName, " ", this.state.speakerDataOne.lastName), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
        className: "margintopbottom20",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 45
