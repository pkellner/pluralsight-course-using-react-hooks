...
//const SpeakerCardDetail = ({ id, firstName, lastName,bioShort, speakingSaturday, speakingSunday,  favorite, heartFavorite }) => {     // WITHOUT REACT.MEMO
const SpeakerCardDetail = React.memo(
  ({
    ...
    useEffect(() => {
      ...
      console.log(
        `SpeakerCardDetail.js:numRendersRef:${numRendersRef.current} ${id}`
      );
    });
